...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1537: x0 => x0.length,
      _1622: () => globalThis.Notification.requestPermission(),
      _1624: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1625: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1626: x0 => globalThis.firebase_core.getApp(x0),
      _1627: () => globalThis.firebase_core.getApp(),
      _1628: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      _1630: x0 => globalThis.firebase_messaging.getMessaging(x0),
      _1632: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      _1634: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      _1635: (x0,x1) => ({next: x0,error: x1}),
      _1640: x0 => x0.title,
      _1641: x0 => x0.body,
      _1642: x0 => x0.image,
      _1643: x0 => x0.messageId,
      _1644: x0 => x0.collapseKey,
      _1645: x0 => x0.fcmOptions,
      _1646: x0 => x0.notification,
      _1647: x0 => x0.data,
      _1648: x0 => x0.from,
      _1649: x0 => x0.analyticsLabel,
      _1650: x0 => x0.link,
      ...
      _1655: () => globalThis.firebase_core.SDK_VERSION,
      _1662: x0 => x0.apiKey,
      _1664: x0 => x0.authDomain,
      _1666: x0 => x0.databaseURL,
      _1668: x0 => x0.projectId,
      _1670: x0 => x0.storageBucket,
      _1672: x0 => x0.messagingSenderId,
      _1674: x0 => x0.measurementId,
      _1676: x0 => x0.appId,
      _1678: x0 => x0.name,
      _1679: x0 => x0.options,
      _1680: (x0,x1) => x0.getItem(x1),
      _1681: (x0,x1,x2) => x0.setItem(x1,x2),
      _1682: (x0,x1) => x0.createElement(x1),
      _1683: (x0,x1) => x0.debug(x1),
      ...
      _1686: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1687: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1688: (x0,x1) => x0.createScriptURL(x1),
      _1689: (x0,x1,x2) => x0.createScript(x1,x2),
      ...
      _1763: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1764: () => new TextDecoder("utf-8", {fatal: true}),
      _1765: () => new TextDecoder("utf-8", {fatal: false}),
      _1766: x0 => new WeakRef(x0),
      _1767: x0 => x0.deref(),
      _1773: Date.now,
      _1775: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1776: s => {
      ...
      _1778: () => typeof dartUseDateNowForTicks !== "undefined",
      _1779: () => 1000 * performance.now(),
      _1780: () => Date.now(),
      _1781: () => {
      ...
      _1783: () => new WeakMap(),
      _1784: (map, o) => map.get(o),
      _1785: (map, o, v) => map.set(o, v),
      _1786: () => globalThis.WeakRef,
      ...
      _1913: x0 => x0.abort(),
      _1914: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1915: (x0,x1) => globalThis.fetch(x0,x1),
      _1916: (x0,x1) => x0.get(x1),
      _1917: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1917(f,arguments.length,x0,x1,x2) }),
      _1918: (x0,x1) => x0.forEach(x1),
      _1919: x0 => x0.getReader(),
      _1920: x0 => x0.cancel(),
      _1921: x0 => x0.read(),
      _1923: x0 => x0.trustedTypes,
      _1925: (x0,x1) => x0.text = x1,
      _1941: (s, m) => {
        try {
      ...
      _3495: (x0,x1) => x0.crossOrigin = x1,
      _3497: (x0,x1) => x0.text = x1,
      _3972: () => globalThis.window,
      _4300: x0 => x0.trustedTypes,
      _4301: x0 => x0.sessionStorage,
      _6676: x0 => x0.signal,
      ...
      _9311: x0 => x0.body,
      _12976: x0 => x0.name,
      _13704: () => globalThis.console,
      _13735: x0 => x0.name,
      _13736: x0 => x0.message,
      _13737: x0 => x0.code,
